public class BloodElf extends Character{

    int levelOfDamage;
    int recovery;
    int levelOfBlood;

    public BloodElf(String name,int health,int power,String profession,int levelOfDamage,int recovery,int levelOfBlood){
